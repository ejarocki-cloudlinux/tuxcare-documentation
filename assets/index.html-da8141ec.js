...
}`,j=`composer config repositories.tuxcare '{"type":"composer","url":"https://nexus.repo.tuxcare.com/repository/els_php/","options":{"http":{"verify":true}}}' --json`,w={__name:"index.html",setup(_){return(E,n)=>{const i=r("ELSPrerequisites"),o=r("CodeTabs"),u=r("TableTabs"),d=r("ELSSteps"),m=r("RouterLink"),c=r("WhatsNext");return f(),h("div",null,[n[26]||(n[26]=a('<h1 id="symfony" tabindex="-1"><a class="header-anchor" href="#symfony" aria-hidden="true">#</a> Symfony</h1><p>Endless Lifecycle Support (ELS) for Symfony components such as Symfony Process, Symfony HttpFoundation from TuxCare provides security fixes for Symfony component versions that have reached their end-of-life. This allows you to continue running your applications without vulnerability concerns, even after official support has ended.</p><h2 id="supported-versions" tabindex="-1"><a class="header-anchor" href="#supported-versions" aria-hidden="true">#</a> Supported Versions</h2><ul><li><strong>Symfony Process</strong> 3.4.x, 4.4.x, 5.x, 6.x</li><li><strong>Symfony HttpFoundation</strong> 2.8.x, 3.4.x, 4.4.x</li><li><strong>Symfony HttpKernel</strong> 3.4.x, 7.4.x</li><li><strong>Symfony Mailer</strong> 6.4.x</li><li><strong>Symfony Mime</strong> 5.4.x, 6.4.x, 7.4.x</li><li><strong>Symfony Routing</strong> 3.4.x, 4.4.x, 5.4.x, 6.4.x, 7.4.x</li><li><strong>Symfony Yaml</strong> 2.8.x, 3.4.x, 4.4.x</li></ul><p>Other versions upon request.</p><h2 id="installation" tabindex="-1"><a class="header-anchor" href="#installation" aria-hidden="true">#</a> Installation</h2>',6)),l(i,null,{default:t(()=>n[0]||(n[0]=[e("ul",null,[e("li",null,[s("Nexus repository access credentials (username and password) — contact "),e("a",{href:"mailto:sales@tuxcare.com"},"sales@tuxcare.com")]),e("li",null,[s("To browse available artifacts, visit TuxCare "),e("a",{href:"https://nexus.repo.tuxcare.com/#browse/browse:els_php",target:"_blank",rel:"noopener noreferrer"},"Nexus"),s(" and click Sign in in the top right corner. You may need to refresh the page after logging in.")])],-1)])),_:1,__:[0]}),l(d,null,{default:t(()=>[e("ol",null,[n[17]||(n[17]=e("li",{id:"locate-the-authjson-file"},[e("p",null,[s("Locate the "),e("code",null,"auth.json"),s(" file")]),e("p",null,[s("Composer reads credentials from a per-user "),e("code",null,"auth.json"),s(". Create or edit the file at:")]),e("ul",null,[e("li",{id:"linuxmacos"},[e("p",null,[e("strong",null,"Linux/macOS"),s(":")]),e("div",{class:"language-text line-numbers-mode","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`~/.composer/auth.json
