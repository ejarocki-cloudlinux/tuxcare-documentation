...
Endless Lifecycle Support (ELS) for Thruway from TuxCare provides security fixes for Thruway (a PHP WAMP/WebSocket router) versions that have reached their end of life. This allows you to continue running your applications without vulnerability concerns, even after official support has ended.
...
* ![](/images/eye.webp) [CVE Tracker](https://tuxcare.com/cve-tracker/?q=voryx%2Fthruway) — Track vulnerability fixes and updates
* ![](/images/bolt.webp) [Available fixes](https://tuxcare.com/cve-tracker/fixes?q=voryx%2Fthruway) — Patched versions and changelogs
* ![](/images/shield-alert.webp) [VEX feed](https://security.tuxcare.com/vex/cyclonedx/els_lang_php/voryx/thruway/) — Vulnerability Exploitability eXchange feed
