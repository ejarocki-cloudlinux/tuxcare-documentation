...
Endless Lifecycle Support (ELS) for Ratchet from TuxCare provides security fixes for Ratchet (a PHP WebSocket server) versions that have reached their end of life. This allows you to continue running your applications without vulnerability concerns, even after official support has ended.
...
* ![](/images/bolt.webp) [Available fixes](https://tuxcare.com/cve-tracker/fixes?q=cboden%2Fratchet) — Patched versions and changelogs
